...
Licensed under **GPL-3.0-or-later** — see [`LICENSE`](LICENSE). The web dashboard
layer is built on Flask following the architecture of [InkyPi](https://github.com/fatihak/InkyPi)
(GPL-3.0); all widget, driver, scheduler and onboarding code is original.
